/*
  ...
  Notes:
  - Some opcodes are not emitted by the compiler in normal JS syntax (e.g., ARR_PUSH, CAST, GEN_*,
    MEM_* helpers, CUSTOM at a reachable position). For those we assemble raw bytecode directly.
